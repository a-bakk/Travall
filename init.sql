CREATE DATABASE JEGYFOGLALAS_NEW;

USE JEGYFOGLALAS_NEW;
...
INSERT INTO jarat(tipus, szolgaltato, ev, honap, nap, honnan_varos_id, hova_varos_id) VALUES
    ('repulo', 'Wizz Air', 2022, 12, 3, 1, 12),
    ('repulo', 'Wizz Air', 2022, 12, 8, 2, 20),
    ('repulo', 'Wizz Air', 2022, 12, 20, 10, 33),
    ('repulo', 'Wizz Air', 2022, 12, 29, 8, 17),
    ('repulo', 'Lufthansa', 2022, 12, 2, 31, 41),
    ('repulo', 'Lufthansa', 2022, 12, 17, 14, 35),
    ('repulo', 'Lufthansa', 2022, 12, 8, 39, 40),
    ('repulo', 'Air France', 2022, 12, 24, 20, 44),
    ('repulo', 'Air France', 2022, 12, 29, 42, 18),
    ('repulo', 'Air France', 2022, 12, 30, 38, 17),
    ('repulo', 'Ryan Air', 2022, 12, 3, 9, 36),
    ('repulo', 'Ryan Air', 2022, 12, 9, 24, 45),
    ('repulo', 'Austrian Airlines', 2022, 12, 15, 8, 11),
    ('repulo', 'KLM Royal Dutch Airlines', 2022, 12, 26, 22, 24),
    ('repulo', 'British Airways', 2022, 12, 30, 36, 16),
